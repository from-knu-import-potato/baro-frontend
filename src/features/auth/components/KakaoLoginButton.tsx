...
const KakaoLoginButton = ({ onClick }: KakaoLoginButtonProps) => {
  return (
    <button
      onClick={onClick}
      className="w-full bg-[#FEE500] hover:bg-[#FDD835] text-black/85 font-bold py-3 sm:py-4 px-6 rounded-[12px] flex items-center justify-center gap-3 transition-all duration-300 shadow-md hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
    >
