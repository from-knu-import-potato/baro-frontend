...
const AiDemandPredictionBubble = ({ prediction }: AiDemandPredictionBubbleProps) => {
  return (
    <Card className="border-baro-blue/30 bg-gradient-to-br from-blue-50 to-white dark:from-blue-950/20 dark:to-background">
      ...
      <CardContent className="flex flex-col gap-4">
        ...
        <div className="flex items-start gap-3">
          {/* AI 아바타 */}
          <div className="flex-shrink-0 w-9 h-9 rounded-full bg-baro-blue flex items-center justify-center shadow-sm">
          ...
          <div className="relative flex-1">
            {/* 꼬리 */}
            <div className="absolute -left-2 top-3 w-0 h-0 border-t-[6px] border-t-transparent border-r-[8px] border-r-baro-blue/20 border-b-[6px] border-b-transparent" />
