...
const AppHeader = ({
  ...
  return (
    <header className="bg-background h-13 border-b flex items-center justify-between px-4 gap-3 sticky top-0 z-10 md:justify-end md:px-6">
      ...
      <div className="flex items-center gap-3">
        ...
        {isLoading ? (
          ...
          <div className="flex items-center gap-2 rounded-lg md:gap-4">
            <div className="w-7 h-7 rounded-full bg-baro-blue flex items-center justify-center shrink-0">
