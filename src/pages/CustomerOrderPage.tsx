...
import { MOCK_SHOP_MENU } from '@/features/orders/data/order.mock';
...
const CustomerOrderPage = () => {
  ...
  const handleOrder = () => {
    ...
    addOrder({
      ...
      totalAmount,
      status: 'pending',
      tableNumber: tableNumber.trim() ? `${tableNumber.trim()}번 테이블` : undefined,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* 헤더 */}
      <header className="bg-baro-blue px-5 py-4 flex items-center gap-3">
        ...
        <DialogContent className="max-w-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="table-number" className="text-sm text-gray-700">
                테이블 번호 <span className="text-gray-400 font-normal">(선택)</span>
              </Label>
              <Input
                id="table-number"
                placeholder="예: 3"
